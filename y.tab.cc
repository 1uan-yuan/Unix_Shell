...
{
       0,   232,   232,   235,   239,   242,   243,   252,   253,   257,
     264,   271,   279,   287,   294,   304,   305,   309,   312,   316,
     317,   321,   328,   336,   337,   341
};
#endif
...
{
  "$end", "error", "$undefined", "WORD", "NOTOKEN", "EXIT", "GREAT",
  "NEWLINE", "LESS", "PIPE", "GREATGREAT", "GREATAMPERSAND",
  "GREATGREATAMPERSAND", "AMPERSAND", "TWOGREAT", "$accept", "goal",
  "command_line", "command_list", "io_modifier_options",
  "io_modifier_list", "background_optional", "pipe_list", "cmd_and_args",
  "cmd", "arg_list", "arg", YY_NULLPTR
};
#endif
...
{
      10,    -4,    -7,    -7,    -7,     1,    -7,     9,    11,    -7,
      -7,    -7,    -7,    -7,    15,    -6,    16,    -7,    18,    19,
      20,    21,    22,    -7,    23,    -7,    24,    -7,    -7,    -7,
      -7,    -7,    -7,    -7,    -7,    -7
};
...
{
       0,     0,    22,     6,     4,     0,     7,     0,    16,    19,
      24,     5,     1,     8,     0,    18,    21,    20,     0,     0,
       0,     0,     0,    17,     0,    15,     0,    25,    23,     9,
      13,    10,    11,    12,    14,     3
};
...
static const yytype_int8 yytable[] =
{
      18,    12,    19,    11,    20,    21,    22,    23,    24,    -2,
       1,     1,     2,     2,     3,     3,     4,     4,     2,    27,
      14,    29,    30,    31,    32,    33,    34,    17,     0,     0,
       0,    35,    13
};
...
{
       0,     1,     3,     5,     7,    16,    17,    18,    22,    23,
      24,     7,     0,    17,     9,    20,    25,    23,     6,     8,
      10,    11,    12,    13,    14,    19,    21,     3,    26,     3,
       3,     3,     3,     3,     3,     7
};
...
#line 264 "shell.y"
    ...
    Shell::_currentCommand._append = (yyvsp[0].cpp_string);
  }
#line 1605 "y.tab.cc"
    break;
...
#line 341 "shell.y"
    ...
    std::string arg = std::string((yyvsp[0].cpp_string)->c_str());
    if (((arg.find('*')) != std::string::npos) || ((arg.find('?')) != std::string::npos)) {
      // fprintf(stderr, "Could be here!\n");
      expandWildcard("", std::string((yyvsp[0].cpp_string)->c_str()));
